...
%
% equivalent to symplecticSubspace2SymBasis(symBasis2SymplecticSubspace(X,v),targetv);

%crappy implementation for now...
[X, targetv]=symplecticSubspace2SymBasis(symBasis2SymplecticSubspace(X,v),targetv);
